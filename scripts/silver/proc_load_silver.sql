...
BEGIN
	...
	BEGIN -- Try Block 
			...
			RAISE NOTICE '==========================================';
			RAISE NOTICE '✅Starting data load into Silver tables...';
			RAISE NOTICE '==========================================';

			start_time := clock_timestamp();
			---------------------------------------------------------------------------------------------------------
			-- Insert Values into silver.crm_cust_info
			---------------------------------------------------------------------------------------------------------
			...
			RAISE NOTICE 'Duration for loading silver.crm_cust_info: % seconds',EXTRACT(EPOCH FROM (end_time - start_time));


			start_time := clock_timestamp();
			---------------------------------------------------------------------------------------------------------
			-- Insert Values into silver.crm_prd_info
			---------------------------------------------------------------------------------------------------------
			...
			end_time := clock_timestamp();
			RAISE NOTICE 'Duration for loading silver.crm_prd_info: % seconds',EXTRACT(EPOCH FROM (end_time - start_time));


			start_time := clock_timestamp();
			---------------------------------------------------------------------------------------------------------
			-- Insert Values into silver.crm_sales_details
			---------------------------------------------------------------------------------------------------------
			...
			end_time := clock_timestamp();
			RAISE NOTICE 'Duration for loading silver.crm_sales_details: % seconds',EXTRACT(EPOCH FROM (end_time - start_time));



			start_time := clock_timestamp();
			---------------------------------------------------------------------------------------------------------
			-- Insert Values into silver.erp_cust_az12
			---------------------------------------------------------------------------------------------------------
			...
			end_time :=  clock_timestamp();
			RAISE NOTICE  'Duration for loading silver.erp_cust_az12: % seconds',EXTRACT(EPOCH FROM (end_time - start_time));
			...
			end_time := clock_timestamp();
			RAISE NOTICE 'Duration for loading silver.erp_loc_a101: % seconds',EXTRACT(EPOCH FROM (end_time - start_time));
			...
			end_time := clock_timestamp();
			RAISE NOTICE 'Duration for loading silver.erp_px_cat_g1v2: % seconds',EXTRACT(EPOCH FROM (end_time - start_time));


			batch_end_time := clock_timestamp();
			RAISE NOTICE 'Total Duration For Loading Silver Table: % seconds',EXTRACT(EPOCH FROM (batch_end_time-batch_start_time));
